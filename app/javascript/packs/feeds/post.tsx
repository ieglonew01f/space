...
import { HeartOutlined, DeleteOutlined, QuestionCircleOutlined, FieldTimeOutlined } from '@ant-design/icons';
...
export class PostCard extends React.Component<Post.IProps, Post.IState> {
  ...
  render() {
    ...
    return (
      ...
      <Row>
        <Col span={3}>
          <Avatar size={55} src="https://c.wallhere.com/photos/4f/a3/1920x1080_px_blue_eyes_brunette_Miranda_Kerr_model_women-588268.jpg!d" />
        </Col>
        <Col span={21}>
